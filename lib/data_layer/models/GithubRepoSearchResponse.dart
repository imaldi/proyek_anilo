...
//
//     final githubRepoSearchResponse = githubRepoSearchResponseFromJson(jsonString);

import 'dart:convert';

GithubRepoSearchResponse githubRepoSearchResponseFromJson(String str) =>
    GithubRepoSearchResponse.fromJson(json.decode(str));

String? githubRepoSearchResponseToJson(GithubRepoSearchResponse data) => json.encode(data.toJson());
...
class GithubRepoSearchResponse {
  ...
  List<GithubReposModel>? items;

  GithubRepoSearchResponse copyWith({
    int? totalCount,
    bool? incompleteResults,
    List<GithubReposModel>? items,
  }) =>
  ...
  factory GithubRepoSearchResponse.fromJson(Map<String, dynamic> json) => GithubRepoSearchResponse(
        totalCount: json["total_count"] == null ? null : json["total_count"],
        incompleteResults: json["incomplete_results"] == null ? null : json["incomplete_results"],
        items: json["items"] == null
            ? null
            : List<GithubReposModel>.from(json["items"].map((x) => GithubReposModel.fromJson(x))),
      );
...
class GithubReposModel {
  ...
  factory GithubReposModel.fromJson(Map<String, dynamic> json) => GithubReposModel(
...
enum DefaultBranch { MASTER, MAIN, GH_PAGES }

final defaultBranchValues =
    EnumValues({"gh-pages": DefaultBranch.GH_PAGES, "main": DefaultBranch.MAIN, "master": DefaultBranch.MASTER});
